...
### HTTP服务压力测试工具 <a href="#http-fu-wu-ya-li-ce-shi-gong-ju" id="http-fu-wu-ya-li-ce-shi-gong-ju"></a>

在项目正式上线之前，我们通常需要通过压测来评估当前系统能够支撑的请求量、排查可能存在的隐藏bug，同时了解了程序的实际处理能力能够帮我们更好的匹配项目的实际需求，节约资源成本。

### 压测相关术语 <a href="#ya-ce-xiang-guan-shu-yu" id="ya-ce-xiang-guan-shu-yu"></a>
...
### 压力测试工具 <a href="#ya-li-ce-shi-gong-ju" id="ya-li-ce-shi-gong-ju"></a>

#### ab <a href="#ab" id="ab"></a>
...
#### go-wrk <a href="#go-wrk" id="go-wrk"></a>
