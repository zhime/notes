...
#### gin默认的中间件 <a href="#gin-mo-ren-de-zhong-jian-jian" id="gin-mo-ren-de-zhong-jian-jian"></a>
...
#### 基于zap的中间件 <a href="#ji-yu-zap-de-zhong-jian-jian" id="ji-yu-zap-de-zhong-jian-jian"></a>
...
_如果不想自己实现，可以使用github上有别人封装好的_[_https://github.com/gin-contrib/zap_](https://github.com/gin-contrib/zap)_。_
...
#### 在gin项目中使用zap <a href="#zai-gin-xiang-mu-zhong-shi-yong-zap" id="zai-gin-xiang-mu-zhong-shi-yong-zap"></a>
...
完整示例代码我已经上传至github：[gin\_zap\_demo](https://github.com/Q1mi/gin_zap_demo)
